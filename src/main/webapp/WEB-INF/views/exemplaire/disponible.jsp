...
<%
    ...
    if (success != null && !success && errorMessage != null) {
%>
    <div id="errorModal" class="popup" style="display: block;">
        <div class="popup-content">
            <h3>Erreur</h3>
            <p><%= errorMessage %></p>
    ...
    <div class="popup-overlay" id="errorOverlay" style="display: block;"></div>
<%
    }
%>
